...
import com.tcs.ins.assign.api.model.ErrorMessage;
import com.tcs.ins.assign.api.model.ErrorMessages;
	...
	private ResponseEntity<ErrorMessage> getErrorMessage(ApplicationException ex) {
		...
		case DATA_EMPTY:
			...
			response = ResponseEntity.badRequest()
					.body(new ErrorMessage(String.valueOf(HttpStatus.NOT_FOUND.value()), ex.getMessage()));
			break;
		case DATA_DUPLICATE:
		case DATA_INTEGRITY:
		case DATA_INVALID:
